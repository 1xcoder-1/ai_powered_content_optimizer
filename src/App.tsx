  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans p-4 sm:p-6 md:p-8 w-full max-w-full overflow-x-hidden">
      ...
      <div className="app-container max-w-full w-full mx-auto relative">
        ...
        <div className="footer-section max-w-6xl mx-auto px-4 mt-20 transform transition-all duration-300">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12 relative">
            How TextFlow AI Works
            <span className="absolute bottom-[-10px] left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full"></span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="step-card rounded-xl p-8 hover-card transform transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center">
              <div className="step-number flex items-center justify-center w-16 h-16 rounded-2xl mb-6">
                <span className="text-2xl font-bold text-white">1</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Input Your Content</h3>
              <p className="text-gray-600">
                Paste or type your text into our editor. We support all major formats and languages.
              </p>
            </div>
            <div className="step-card rounded-xl p-8 hover-card transform transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center">
              <div className="step-number flex items-center justify-center w-16 h-16 rounded-2xl mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Set Optimization Goals</h3>
              <p className="text-gray-600">
                Define how you want your content improved - tone, clarity, length, or style.
              </p>
            </div>
            <div className="step-card rounded-xl p-8 hover-card transform transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center">
              <div className="step-number flex items-center justify-center w-16 h-16 rounded-2xl mb-6">
              ...
              <p className="text-gray-600">
                Receive professionally optimized content in seconds, ready for use.
              </p>
            </div>
          </div>
        </div>
